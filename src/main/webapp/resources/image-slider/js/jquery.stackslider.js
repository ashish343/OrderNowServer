...
;( function( $, window, undefined ) {
	...
	*/
	...
	var $window = $(window),
		$document = $(document),
		Modernizr = window.ModernizrSlider;
	...
	$.StackSlider.prototype = {
		...
		_init : function( options ) {
			...
			this.support = ModernizrSlider.csstransitions && ModernizrSlider.csstransforms3d;
			...
			if( this.support ) {
				this.transEndEventName = transEndEventNames[ ModernizrSlider.prefixed( 'transition' ) ] + '.stackslider';
				this.transformName = transformNames[ ModernizrSlider.prefixed( 'transform' ) ];
			}
