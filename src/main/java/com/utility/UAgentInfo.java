...
//The following devices are explicitly ok. ﻿//Note: 'High' BlackBerry devices ONLY
    	if(detectMobileQuick()) {
    ...
    public boolean detectTierOtherPhones() {
    	if ((this.initCompleted == true) || (this.isTierGenericMobile == true)) return this.isTierGenericMobile;
