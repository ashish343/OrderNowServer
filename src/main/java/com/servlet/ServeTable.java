...
public class ServeTable  extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	boolean isDebug = IS_VALID.equals(request.getParameter(UrlParameter.DEBUG.toString()));
    	...
    	String restuarantId = TableHandler.getValidRestuarant(tableId, debugger);
    	if(restuarantId != null) {
    		data = TableHandler.getRestaurantInformation(restuarantId, debugger);
    	} else {
