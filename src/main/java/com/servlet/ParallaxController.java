...
@WebServlet(name = "ParallaxServlet", urlPatterns = { "/parallax" })
public class ParallaxController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (uAgent.isMobilePhone || uAgent.isTierTablet) {
			request.getRequestDispatcher("/WEB-INF/jsp/new-home.jsp").forward(
					request, response);
		} else {
			request.getRequestDispatcher("/WEB-INF/jsp/home-parallax.jsp")
